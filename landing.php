						...
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="register-form" action="" method="post" onsubmit="return(signup());" role="form" style="display: none;">
									<div class="form-group">
										<input type="text" name="username" id="name" tabindex="1" class="form-control" placeholder="Username" value="" onfocus="doit()" onblur="nor(this.id)">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<input type="password" name="cpass" onblur="nor(this.id)" id="confirm-password" tabindex="2" class="form-control" placeholder="Confirm Password">
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
